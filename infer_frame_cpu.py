...
def check_sleeping(net, height_size, track, smooth, img):
    net = net.eval()
    # net = net.cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_path', type=str,required=True, help='input image')
    ...
    print(check_sleeping(net, args.height_size, args.track, args.smooth, img))
